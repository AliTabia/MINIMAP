...
{ m -> map = IMG_Load("background.png");
  m-> minibonhomme = IMG_Load("hero.png");
  m->positionmap.x =252;
  m->positionmap.y =19;
}
...
{ m1 -> map = IMG_Load("mini.jpg");
  m1-> minibonhomme = IMG_Load("download.png");
  m1->positionmap.x =300;
  m1->positionmap.y =400;
  m1->posminibonhomme.x =300;
  m1->posminibonhomme.y =100;
}
